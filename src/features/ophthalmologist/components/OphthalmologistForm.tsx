...
import type { OphthalmologistProps } from "../types/ophthalmologist.interface";
import { useOphthalmologistForm } from "../hooks/useOphthalmologistForm";

export function OphthalmologistForm({ initialValues }: OphthalmologistProps) {
  const { form, onSubmit, isPending, errorMessage } =
    useOphthalmologistForm(initialValues);
                    ...
                    <FieldGroup>
                      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-ophthalmologist-responsavel">
                                Nome completo
                              </FieldLabel>
                        ...
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-ophthalmologist-data_nascimento">
                                Data de Nascimento
                              </FieldLabel>
                              <Popover>
                                <PopoverTrigger>
                        ...
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-ophthalmologist-status">
                                Status
                              </FieldLabel>
                              <select
                                {...field}
