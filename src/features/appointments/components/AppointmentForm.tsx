...
import type { AppointmentProps } from "../types/appointment.type";
...
export function AppointmentForm({ initialValues }: AppointmentProps) {
                    ...
                    <FieldGroup>
                      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-2">
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-Appointment-nome">
                                Convênio
                              </FieldLabel>
                        ...
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-Appointment-registro">
