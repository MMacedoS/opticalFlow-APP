...
import type { OptometristProps } from "../types/optometrist.interface";
import { useOptometristForm } from "../hooks/useOptometristForm";

export function OptometristForm({ initialValues }: OptometristProps) {
  const { form, onSubmit, isPending, errorMessage } =
    useOptometristForm(initialValues);
        ...
        children={
          <>
            <CardPage
              ...
              children={
                <>
                  <form id="form-Optometrist" onSubmit={onSubmit} noValidate>
                    <FieldGroup>
                      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-Optometrist-responsavel">
                                Nome completo
                              </FieldLabel>
                        ...
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-Optometrist-data_nascimento">
                                Data de Nascimento
                              </FieldLabel>
                              <Popover>
                                <PopoverTrigger>
                        ...
                        <Controller
                          ...
                          render={({ field, fieldState }) => (
                            <Field data-invalid={fieldState.invalid}>
                              <FieldLabel htmlFor="form-Optometrist-status">
                                Status
                              </FieldLabel>
                              <select
                                {...field}
